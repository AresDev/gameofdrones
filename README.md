...
You need git to clone the gameofdrones repository. You can get git from
[http://git-scm.com/](http://git-scm.com/).

We also use a number of node.js tools to initialize and test gameofdrones. You must have node.js and
...
gameofdrones changes this location through the `.bowerrc` file.  Putting it in the app folder makes
...
The gameofdrones app comes preconfigured with unit tests. These are written in
...
The gameofdrones app comes with end-to-end tests, again written in [Jasmine][jasmine]. These tests
